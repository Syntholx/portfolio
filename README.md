...
- Support Ticket Manager `v0.2.0` — ukończone interaktywne MVP konsolowe w
  ...
  i walidację danych zgłoszenia. Kod źródłowy:
  https://github.com/Syntholx/support-ticket-manager/tree/v0.2.0

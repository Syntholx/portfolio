const translations = {
  pl: {
    ...
    "projects.status": "MVP 3 ukończone · v0.3.0",
    ...
    "projects.codeLink": "Zobacz kod źródłowy v0.3.0",
  ...
  nl: {
    ...
    "projects.status": "MVP 3 voltooid · v0.3.0",
    "projects.description":
    ...
    "projects.codeLink": "Bekijk de broncode van v0.3.0",
  ...
  en: {
    ...
    "projects.status": "MVP 3 complete · v0.3.0",
    "projects.description":
    ...
    "projects.codeLink": "View the v0.3.0 source code",
    "contact.title": "Contact",

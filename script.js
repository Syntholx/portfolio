const translations = {
  pl: {
    ...
    "projects.status": "MVP 5 ukończone · v0.5.0",
    "projects.description":
      "Interaktywna aplikacja konsolowa pomagająca pracownikowi wsparcia przeglądać, wyszukiwać i obsługiwać zgłoszenia.",
    ...
    "projects.featureMenu": "Interaktywne menu i wybór operacji",
    ...
    "projects.featureTests": "22 testy jednostkowe reguł i tworzenia zgłoszeń",
    "projects.codeLink": "Zobacz kod źródłowy v0.5.0",
  ...
  nl: {
    ...
    "projects.status": "MVP 5 voltooid · v0.5.0",
    "projects.description":
      "Een interactieve consoleapplicatie waarmee een supportmedewerker tickets kan bekijken, zoeken en behandelen.",
    ...
    "projects.featureMenu": "Interactief menu en keuze van acties",
    ...
    "projects.featureTests": "22 unittests voor bedrijfsregels en het aanmaken van tickets",
    "projects.codeLink": "Bekijk de broncode van v0.5.0",
  ...
  en: {
    ...
    "projects.status": "MVP 5 complete · v0.5.0",
    "projects.description":
      "An interactive console application that helps a support employee view, find, and handle tickets.",
    ...
    "projects.featureMenu": "Interactive menu and operation selection",
    ...
    "projects.featureTests": "22 unit tests for business rules and ticket creation",
    "projects.codeLink": "View the v0.5.0 source code",
    "contact.title": "Contact",

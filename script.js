const translations = {
  pl: {
    ...
    "projects.status": "MVP 2 ukończone · v0.2.0",
    ...
    "projects.codeLink": "Zobacz kod źródłowy v0.2.0",
  ...
  nl: {
    ...
    "projects.status": "MVP 2 voltooid · v0.2.0",
    "projects.description":
    ...
    "projects.codeLink": "Bekijk de broncode van v0.2.0",
  ...
  en: {
    ...
    "projects.status": "MVP 2 complete · v0.2.0",
    "projects.description":
    ...
    "projects.codeLink": "View the v0.2.0 source code",
    "contact.title": "Contact",

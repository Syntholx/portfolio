const translations = {
  pl: {
    ...
    "projects.placeholder": "Pierwszy projekt C#/.NET w przygotowaniu",
    "projects.heading": "Projekty backendowe wkrótce",
    "projects.description":
      "Pojawią się tutaj samodzielne aplikacje wraz z opisem problemu, wykorzystanych technologii, kodem źródłowym i wersją demonstracyjną.",
  ...
  nl: {
    ...
    "projects.placeholder": "Eerste C#/.NET-project in voorbereiding",
    "projects.heading": "Binnenkort backendprojecten",
    "projects.description":
      "Hier verschijnen zelfstandige applicaties met een beschrijving van het probleem, de gebruikte technologieën, de broncode en een demonstratieversie.",
  ...
  en: {
    ...
    "projects.placeholder": "First C#/.NET project in preparation",
    "projects.heading": "Backend projects coming soon",
    "projects.description":
      "This section will feature independent applications with the problem description, technologies used, source code, and a live demonstration.",
    "contact.title": "Contact",

const translations = {
  pl: {
    ...
    "projects.status": "MVP 1 ukończone · v0.1.0",
    ...
    "projects.codeLink": "Zobacz kod źródłowy v0.1.0",
  ...
  nl: {
    ...
    "projects.status": "MVP 1 voltooid · v0.1.0",
    "projects.description":
    ...
    "projects.codeLink": "Bekijk de broncode van v0.1.0",
  ...
  en: {
    ...
    "projects.status": "MVP 1 complete · v0.1.0",
    "projects.description":
    ...
    "projects.codeLink": "View the v0.1.0 source code",
    "contact.title": "Contact",

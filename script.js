const translations = {
  pl: {
    ...
    "projects.status": "MVP 7 ukończone · v0.7.0",
    "projects.description":
      "Aplikacja C#/.NET z API do tworzenia i obsługi zgłoszeń, walidacją oraz testami. Osobne demo interfejsu pokazuje przykładowy przebieg pracy — bez połączenia z API.",
    ...
    "projects.featureMenu": "API HTTP oraz zachowana aplikacja konsolowa",
    "projects.featureSearch": "Wyszukiwanie zgłoszeń po ID",
    "projects.featureLifecycle": "Kontrolowane zmiany statusu i priorytetu",
    "projects.featureValidation": "Walidacja danych zgłoszenia",
    "projects.featureArchitecture": "Podział odpowiedzialności między klasy aplikacji",
    "projects.featureCreation": "Tworzenie zgłoszeń z automatycznym ID",
    "projects.featureArchive": "Aktywna kolejka i automatyczne archiwum",
    "projects.featureService": "Tworzenie zgłoszeń przez serwis niezależny od konsoli",
    "projects.featureTests": "60 testów: 29 jednostkowych i 31 integracyjnych API",
    "projects.codeLink": "Zobacz kod źródłowy v0.7.0",
    "projects.demoLink": "Wypróbuj demo interfejsu (PL) →",
    "projects.demoNote": "Demo UI przygotowane z pomocą AI: przykładowe dane, symulowane role, bez API i bazy. Zmiany znikają po odświeżeniu. Backend jest uruchamiany lokalnie, nie jest wdrożony produkcyjnie.",
  ...
  nl: {
    ...
    "projects.status": "MVP 7 voltooid · v0.7.0",
    "projects.description":
      "Een C#/.NET-applicatie met een API voor het aanmaken en behandelen van tickets, validatie en tests. Een aparte interfacedemo toont de workflow met voorbeeldgegevens, zonder API-koppeling.",
    ...
    "projects.featureMenu": "HTTP-API en een behouden consoleapplicatie",
    "projects.featureSearch": "Tickets zoeken op ID",
    "projects.featureLifecycle": "Gecontroleerde wijzigingen van status en prioriteit",
    "projects.featureValidation": "Validatie van ticketgegevens",
    "projects.featureArchitecture": "Verdeling van verantwoordelijkheden tussen applicatieklassen",
    "projects.featureCreation": "Tickets aanmaken met een automatisch ID",
    "projects.featureArchive": "Actieve wachtrij en automatisch archief",
    "projects.featureService": "Tickets aanmaken via een service die onafhankelijk is van de console",
    "projects.featureTests": "60 tests: 29 unittests en 31 API-integratietests",
    "projects.codeLink": "Bekijk de broncode van v0.7.0",
    "projects.demoLink": "Probeer de interfacedemo (Pools) →",
    "projects.demoNote": "UI-demo gemaakt met AI-hulp: voorbeeldgegevens en gesimuleerde rollen, zonder API of database. Wijzigingen verdwijnen na het vernieuwen. De backend draait lokaal, niet in productie.",
  ...
  en: {
    ...
    "projects.status": "MVP 7 complete · v0.7.0",
    "projects.description":
      "A C#/.NET application with an API for creating and handling support tickets, validation and tests. A separate interface demo shows the workflow using sample data, without connecting to the API.",
    ...
    "projects.featureMenu": "HTTP API alongside the retained console application",
    "projects.featureSearch": "Finding tickets by ID",
    "projects.featureLifecycle": "Controlled status and priority changes",
    "projects.featureValidation": "Ticket data validation",
    "projects.featureArchitecture": "Separation of responsibilities across application classes",
    "projects.featureCreation": "Creating tickets with automatically assigned IDs",
    "projects.featureArchive": "Active queue and automatic archive",
    "projects.featureService": "Ticket creation through a console-independent service",
    "projects.featureTests": "60 tests: 29 unit tests and 31 API integration tests",
    "projects.codeLink": "View the v0.7.0 source code",
    "projects.demoLink": "Try the interface demo (Polish) →",
    "projects.demoNote": "UI demo built with AI assistance: sample data and simulated roles, no API or database. Changes are lost on refresh. The backend runs locally and is not deployed to production.",
    "contact.title": "Contact",
